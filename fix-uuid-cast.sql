-- ============================================================
--  FIX: "operator does not exist: text = uuid" in upsert_entries_for_code
-- ============================================================
--  Problem: customer_id und location_id werden als TEXT aus dem
--  JSON-Payload extrahiert, aber die DB-Spalten sind UUID-Typ.
--
--  Lösung: Expliziter ::uuid Cast + NULLIF für leere Strings.
--
